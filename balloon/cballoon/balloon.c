...
void balloon_rank(float_matrix *points, float_matrix *seeds, double *labels, long *ranks, bool deflate) {
    ...
    balloon_rank_from_distances(D, labels, ranks, deflate);
    free_float_matrix(D);
}

void py_compute_squared_distances(long n, long s, long dim, double **points, double **seeds, double **D) {
    ...
    dist_mat.nrows = n;
    dist_mat.ncols = s;
    compute_squared_distances(&point_mat, &seed_mat, &dist_mat);
}

void py_balloon_rank_from_distances(long n, long s, double **D, double *labels, long *ranks, bool deflate) {
    float_matrix dist_mat;
    dist_mat.arr = D;
    dist_mat.nrows = n;
    dist_mat.ncols = s;
    balloon_rank_from_distances(&dist_mat, labels, ranks, deflate);
}

void py_balloon_rank(long n, long s, long dim, double **points, double **seeds, double *labels, long *ranks, bool deflate) {
    ...
    seed_mat.nrows = s;
    seed_mat.ncols = dim;
    balloon_rank(&point_mat, &seed_mat, labels, ranks, deflate);
}